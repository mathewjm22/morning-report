...
export default function HighlightsTray({ annotations, setAnnotations, onSendToResearch }) {
  const highlights = [];
      ...
      <div className="flex-1 flex items-center justify-center p-8 text-center">
        <div className="max-w-[240px]">
          ...
          <p className="text-xs text-stone-500 leading-relaxed">
            Select the <span className="font-medium text-stone-700">Highlighter</span> tool and drag over any text in the PDF. Captured phrases appear here with their page number.
          </p>
        </div>
      </div>
    );
